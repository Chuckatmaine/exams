...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { creator_id: @objective.creator_id, department_id: @objective.department_id, locked: @objective.locked, name: @objective.name }
    end
  ...
  test "should update objective" do
    put :update, id: @objective, objective: { creator_id: @objective.creator_id, department_id: @objective.department_id, locked: @objective.locked, name: @objective.name }
    assert_redirected_to objective_path(assigns(:objective))
  end
